	...
	case V4L2_BUF_TYPE_VIDEO_CAPTURE:
		...
		*height &= ~7;
		...
		case V4L2_PIX_FMT_SBGGR8:
			size = f->fmt.pix.width * f->fmt.pix.height;	// 이거 모름.
			bytesperline = f->fmt.pix.width;
			break;
		case V4L2_PIX_FMT_SBGGR10:
			size = f->fmt.pix.width * f->fmt.pix.height * 2;
			//csi_set_16bit_imagpara(f->fmt.pix.width, f->fmt.pix.height);
			bytesperline = f->fmt.pix.width * 2;
			break;
...
void get_code_name(unsigned long id) {
	char debugStr[100];

	switch (id) {
		case V4L2_CID_USER_CLASS:
			sprintf(debugStr,"V4L2_CID_USER_CLASS");
			break;
		case V4L2_CID_BRIGHTNESS:
			sprintf(debugStr,"V4L2_CID_BRIGHTNESS");
			break;
		case V4L2_CID_CONTRAST:
			sprintf(debugStr,"V4L2_CID_CONTRAST");
			break;
		case V4L2_CID_SATURATION:
			sprintf(debugStr,"V4L2_CID_SATURATION");
			break;
		case V4L2_CID_HUE:
			sprintf(debugStr,"V4L2_CID_HUE");
			break;
		case V4L2_CID_AUDIO_VOLUME:
			sprintf(debugStr,"V4L2_CID_AUDIO_VOLUME");
			break;
		case V4L2_CID_AUDIO_BALANCE:
			sprintf(debugStr,"V4L2_CID_AUDIO_BALANCE");
			break;
		case V4L2_CID_AUDIO_BASS:
			sprintf(debugStr,"V4L2_CID_AUDIO_BASS");
			break;
		case V4L2_CID_AUDIO_TREBLE:
			sprintf(debugStr,"V4L2_CID_AUDIO_TREBLE");
			break;
		case V4L2_CID_AUDIO_MUTE:
			sprintf(debugStr,"V4L2_CID_AUDIO_MUTE");
			break;
		case V4L2_CID_AUDIO_LOUDNESS:
			sprintf(debugStr,"V4L2_CID_AUDIO_LOUDNESS");
			break;
		case V4L2_CID_BLACK_LEVEL:
			sprintf(debugStr,"V4L2_CID_BLACK_LEVEL");
			break;
		case V4L2_CID_AUTO_WHITE_BALANCE:
			sprintf(debugStr,"V4L2_CID_AUTO_WHITE_BALANCE");
			break;
		case V4L2_CID_DO_WHITE_BALANCE:
			sprintf(debugStr,"V4L2_CID_DO_WHITE_BALANCE");
			break;
		case V4L2_CID_RED_BALANCE:
			sprintf(debugStr,"V4L2_CID_RED_BALANCE");
			break;
		case V4L2_CID_BLUE_BALANCE:
			sprintf(debugStr,"V4L2_CID_BLUE_BALANCE");
			break;
		case V4L2_CID_GAMMA:
			sprintf(debugStr,"V4L2_CID_GAMMA or V4L2_CID_WHITENESS");
			break;
			break;
		case V4L2_CID_EXPOSURE:
			sprintf(debugStr,"V4L2_CID_EXPOSURE");
			break;
		case V4L2_CID_AUTOGAIN:
			sprintf(debugStr,"V4L2_CID_AUTOGAIN");
			break;
		case V4L2_CID_GAIN:
			sprintf(debugStr,"V4L2_CID_GAIN");
			break;
		case V4L2_CID_HFLIP:
			sprintf(debugStr,"V4L2_CID_HFLIP");
			break;
		case V4L2_CID_VFLIP:
			sprintf(debugStr,"V4L2_CID_VFLIP");
			break;
		default:
			sprintf(debugStr,"No name code");
			break;
	}
	pr_debug("ioctrl code string: %s\n", debugStr);
}
