		...
		unsigned value, unsigned offset)
{
	...
	//printk(KERN_ERR"info->mipi_csi2_base = 0x%X, offset = 0x%X,  value = 0x%X\n", info->mipi_csi2_base, offset, value);
}
...
int mipi_csi2_reset(struct mipi_csi2_info *info)
{
	...
	mipi_csi2_write(info, 0x00000028, MIPI_CSI2_PHY_TST_CTRL1);  // DMJM: change clock from 14 to 28 (to 280 Mbps) for OV5647
